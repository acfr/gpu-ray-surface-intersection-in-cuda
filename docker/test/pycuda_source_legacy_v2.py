...
#
#Notes:
#1) For the purpose of testing the dockerfiles on the ubuntu-d3 machine
#   which provides a RTX 3090 GPU and has CUDA 12.0 installed, we incorporate
#   cleosia's changes to address the memory alignment issue. Without these
#   changes to the legacy code, we may run into the following problems
...
#   This is most likely dependent on device architecture.
#2) However, float precision (Moller algo. implementation) remains unchanged.
#============================================================================
cuda_template = """
#include <stdint.h>
