...
//-----------------------------------------------
// This implementation corresponds to version v2
// It features BVH acceleration structure
//-----------------------------------------------
